...
score = int(input("Please enter the student score: "))




if score >= 90:
    print("The student recive grade A.")
else:
    if score >= 80:
        print("The student will recive grade B.")
    else:
        if score >= 70:
            print("The student will recive grade C.")
        else:
            if score >= 60:
                print("The student will recive grade D.")
            else:
                print("The student will recive grade F.")
